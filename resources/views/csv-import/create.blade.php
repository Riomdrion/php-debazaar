<x-app-layout>
    <div class="max-w-2xl mx-auto p-6 bg-white rounded-xl shadow-md mt-10">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mb-6">
            {{ __('adverts.Importeer') }} {{ $type === 'verhuuradvertenties' ? __('adverts.verhuuradvertenties') : __('adverts.advertenties') }}  {{ __('adverts.via_csv') }}
        </h1>
        ...
        <form action="{{ route('advertenties.csvimport.store', ['type' => $type]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label for="csv_file" class="block text-gray-700 font-medium mb-2">{{ __('adverts.Kies_CSV_bestand') }}</label>
